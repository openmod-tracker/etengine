    ...
    module Cost
      ...
      def marginal_costs
        fetch(:marginal_costs, false) do
          ...
          if output(:electricity).nil?
            ...
            puts "hello #{costs}" if key == :industry_chp_engine_gas_power_fuelmix
      ...
      def variable_costs_per_typical_input(include_waste: true)
        ...
        fetch(cache_key) do
          ...
          # DEZE IS NAN
          puts "carrier cost per mj: #{weighted_carrier_cost_per_mj}" if key == :industry_chp_engine_gas_power_fuelmix
          puts "carrier potential per mj: #{weighted_carrier_potential_co2_per_mj}" if key == :industry_chp_engine_gas_power_fuelmix
